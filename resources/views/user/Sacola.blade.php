...
<body class="bg-gray-100 text-white h-full">
    ...
    <nav class="flex justify-center relative bg-[#2E2E2E] py-6">
        <a href="javascript:history.back()" class="absolute top-2 left-4">
    ...
    <!-- Itens do pedido -->
    <div class="mt-4 px-6">
        <h2 class="text-lg font-medium text-black">Itens do pedido</h2>
    </div>
    ...
    <div id="popup" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden z-50">
        <div class="bg-white border-2 border-black rounded-2xl p-6 w-80 shadow-lg text-center">
            ...
            <div class="flex justify-between mt-4">
                ...
                <button id="close-popup" class="bg-[#a34702] text-white py-2 px-4 rounded-lg w-1/2">Voltar</button>
            </div>
        </div>
    </div>
        ...
        <div class="max-w-lg mx-auto bg-white p-8 rounded-lg shadow">
            ...
            <div class="flex items-center border-b pb-8 mb-12">
                ...
                <div class="flex items-center bg-gray-200 rounded-full px-2 py-1">
                    <button class="p-1 text-orange-500" onclick="decrementar(1)">
                        <i id="icon-1" class="ph ph-minus"></i>
                    </button>
                    <span id="quantidade-1" class="px-3 font-bold text-orange-500 text-sm">1</span>
                    <button class="p-1 text-orange-500" onclick="incrementar(1)">
    ...
    <div class="fixed-bottom">
        <div class="w-full bg-gray-300 rounded-2xl flex items-center justify-between px-4 py-3">
